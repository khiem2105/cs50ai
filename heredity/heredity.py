...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother_name is None and father_name is None:
            ...
            mother_prob = inherit_prob(mother_name, one_gene, two_genes)
            father_prob = inherit_prob(father_name, one_gene, two_genes)
            if num_genes == 2:
        ...
        person_prob *= PROBS["trait"][num_genes][person_trait]
